...
@NodeAttribute(name = "rt_subtract", group = "rendertype_math/basic", graphTypes = {RenderTypeGraph.class, ShaderFunctionGraph.class})
public class SubtractNode extends DynamicBinaryNode {
    @Override
