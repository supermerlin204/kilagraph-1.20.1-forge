...
/** Reads the interpolated {@code cylindricalVertexDistance} varying (float). vsh default: fog distance. */
@NodeAttribute(name = "rt_frag_cylindrical_distance", group = "rendertype_input/fragment", graphTypes = {RenderTypeGraph.class, ShaderFunctionGraph.class})
public class CylindricalDistanceFragmentInputNode extends FragmentInputNode {
    @Override
