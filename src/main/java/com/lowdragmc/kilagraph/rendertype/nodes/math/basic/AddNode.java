...
@NodeAttribute(name = "rt_add", group = "rendertype_math/basic", graphTypes = {RenderTypeGraph.class, ShaderFunctionGraph.class})
public class AddNode extends DynamicBinaryNode {
    @Override
