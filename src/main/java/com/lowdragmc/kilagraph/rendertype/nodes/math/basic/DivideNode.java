...
@NodeAttribute(name = "rt_divide", group = "rendertype_math/basic", graphTypes = {RenderTypeGraph.class, ShaderFunctionGraph.class})
public class DivideNode extends DynamicBinaryNode {
    @Override
